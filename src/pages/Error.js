...
const Error = () => {
  const img404 = require('../assets/images/404-img.png');

  return (
    <main className="error-page">
      <section className="error-area padding-top-140px padding-bottom-30px">
          ...
          <div className="row">
            <div className="col-lg-6 mx-auto">
              <div className="error-content text-center">
                <img src={img404} alt="error" className="w-100" />
                <div className="section-heading padding-top-30px">
                  ...
                  <p className="sec__desc">
                    ...
                    You can check out our <Link to="/" className="color-text">Help Center</Link>
                  </p>
                </div>
